...
({
    doInit: function (component, event, helper) {
                    ...
                    if (base64Context.startsWith('1.')) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                pageReferencePrevious.attributes.relationshipApiName ===
                                'Resource__r'
                            ) {
                                recordId = pageReferencePrevious.attributes.recordId;
                            } else if (
                                pageReferencePrevious.attributes.objectApiName === 'Res_study__c'
                            ) {
                                recordId = '';
                            }
        ...
        let inputVars = [{ name: 'recordId', type: 'String', value: recordId }];
