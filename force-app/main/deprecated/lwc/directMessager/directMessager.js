...
//
// import searchUsers from '@salesforce/apex/DirectMessageRemote.searchUsers';
// import getConversations from '@salesforce/apex/DirectMessageRemote.getConversations';
// import getConversation from '@salesforce/apex/DirectMessageRemote.getConversation';
// import sendMessage from '@salesforce/apex/DirectMessageRemote.sendMessage';
// import replyToMessage from '@salesforce/apex/DirectMessageRemote.replyToMessage';
...
export default class DirectMessager extends LightningElement {
    ...
    //     };
    //
    //     subscribe('/event/DirectMessageEvent__e', -1, messageCallback).then(response => {
    ...
    //     if (result.data) this.conversations = result.data;
    // }
    //
    ...
    //     if (result.data) {
    //         this.messages = [];
    //         for (let m of result.data) this.messages.unshift(m);
    ...
    //     for (let c of this.conversations) {
    //         if (c.id === this.conversationId) return c;
    //     }
    //     return null;
    // }
    //
    ...
    //         if (c) return c.formattedRecipientNames;
    //     }
    //
    //     let result = '';
    //     for (let r of this.newRecipients) result += r.name + ', ';
    //
    ...
    //         //New conversation
    //         let newRecipientIds = '';
    //         for (let r of this.newRecipients) newRecipientIds += r.id + ',';
    //
    ...
    //     });
    //     if (this.newRecipients.length < 9) this.isOverfilled = false;
    // }
    //
    // //Navigation
