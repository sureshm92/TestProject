...
({
    doInit: function (component, event, helper) {
        communityService.executeAction(component, 'getConditionOfInterest', {}, function (
            returnValue
        ) {
    ...
    setReferralSearchResult: function (component, event) {
        ...
        if (sobjectName == 'Referral_Network__c') {
            ...
            if (isChanged === true) component.set('v.isReferalChange', false);
            else component.set('v.isReferalChange', true);
        }
        if (sobjectName == 'Therapeutic_Area__c') {
            component.set('v.therapeticResult', refResult);
            if (isChanged === true) component.set('v.isTherapChange', false);
            else component.set('v.isTherapChange', true);
        }
