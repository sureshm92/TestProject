({
    callServerMethodOnPiChange :function(component, mthdName, usermode, communityname, delegateID, selectedPI, selectedCTP, piaction,helper)
    {
    ...
    callServerMethodOnStudyChange :function(component, mthdName, usermode, communityname, delegateID, selectedPI, selectedCTP, piaction,helper)
    {
        communityService.executeAction(component, mthdName, {
            userMode:usermode,
            communityName: communityname,
