({
    doInit: function (component, event, helper) {
        ...
        let communityType = component.get('v.communityType').trim();
        component.set('v.communityType', communityType);
        // Enqueue Action
        ...
        action.setCallback(this, function (response) {
            ...
            if (response.getReturnValue()) {
                ...
                component.set(
                    'v.cssClassNameMobile',
                    'slds-col slds-p-left--medium slds-p-right--medium slds-size_1-of-4'
                );
