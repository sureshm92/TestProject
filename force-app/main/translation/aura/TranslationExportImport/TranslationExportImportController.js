...
({
    doInit: function (component, event, heper) {
        communityService.executeAction(
            component,
            'getPlatformLevelTranslatableObjects',
            null,
            function (platformObjects) {
    ...
    doExportVisitPlan: function (component, event, helper) {
        ...
        communityService.executeAction(
            ...
            function (generatedFile) {
                ...
                var filename =
                    'Export_' +
                    component.get('v.exportType') +
                    '_' +
                    component.get('v.translateItem.Language__c') +
                    '__' +
                    component.get('v.studySiteVisitPlan.Visit_Plan__r.Name') +
                    '.xlf';
        ...
        communityService.executeAction(
            ...
            function (generatedFile) {
                ...
                var filename =
                    ...
                    component.get('v.translateItem.Language__c') +
                    '__' +
                    component.get('v.studySite.Clinical_Trial_Profile__r.Name') +
                    '.xlf';
                saveAs(blob, filename);
            },
            null,
