...
trigger ClinicalTrialProfileTrigger on Clinical_Trial_Profile__c(
    before insert,
    before update,
    before delete,
    after insert,
    ...
    TriggerHandlerExecutor.execute(MDM_UCPM_CTPCreationTriggerHandler.CreateStudySponser.class);
}