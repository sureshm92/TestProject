({
    doExecute: function (component, event, helper) {
        ...
        component.set('v.ViewRecordId', component.get('v.ViewRecord')[0].Id);
        ...
        communityService.executeAction(
            ...
            {
                studysiteId: component.get('v.ViewRecord[0].Study_Name__c'),
            ...
            function (returnValue) {
                ...
                if (
                    ...
                    if (component.get('v.MO_Email') != 'null') {
                        Picklist_option.push({
                            value:
                                $A.get('$Label.c.PG_MRC_RF_Email') +
                                ': ' +
                                component.get('v.MO_Email')
                        });
                    }
                    Picklist_option.push({
                        value: $A.get('$Label.c.Other_Phone_Number')
                    });
                    Picklist_option.push({
                        value: $A.get('$Label.c.Other_Email')
                    });
                ...
                if (
                    component.get('v.MOEmail') == true &&
                    component.get('v.MOPhone') == false &&
                    component.get('v.Other') == false
                ) {
                    if (component.get('v.MO_Email') != 'null') {
                        Picklist_option.push({
                ...
                var otherpone = $A.get('$Label.c.Other_Phone_Number');
                if (Picklist_option[0].value == otheremail) {
                    ...
                    component.set('v.AlternatePhone_email', component.get('v.MO_AlternateValue'));
                ...
                component.set('v.Picklistdefaultvalue', Picklist_option[0].value);
            }
        );
    ...
    updateMO: function (component, event, helper) {
        ...
        var update = true;
        var other = false;
        var existingvalue_phone =
            $A.get('$Label.c.PG_MRC_RF_Phone') + ': ' + component.get('v.MO_Phonenumber');
        if (picklistval == othermail) {
            other = true;
    ...
    doEnablebutton: function (component, event, helper) {
        var picklistval = component.find('preferredId').get('v.value');
        var othermail = $A.get('$Label.c.Other_Email');
        var otherPhone = $A.get('$Label.c.Other_Phone_Number');
        var Notesval = component.find('notesId').get('v.value');
