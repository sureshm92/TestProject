 ...
 ({
            ...
            if (parent !== null && field !== undefined && field.value !== previousValue) {
                let populateFields =
                    (previousValue === '' ||
                        ...
                        previousValue === null) &&
                    field.value !== '' &&
                    field.populateFields !== undefined &&
                    field.populateFields !== null;
                parent.fieldChanged(
                    field.field,
                    field.value,
                    field.valid,
                    populateFields ? field.populateFields : null
                );
            }
        }
    },
    ...
    doCheckValidity: function (component, event, helper) {
            ...
            if (fieldInput !== undefined && !Array.isArray(fieldInput)) {
                ...
                if (
                    ...
                    (!validity.valueMissing ||
                        (field.value === '' && !field.readonly && field.required))
                ) {
                ...
                fieldInput.forEach(function (input) {
                    ...
                    if (
                        inputValidity !== undefined &&
                        (!inputValidity.valueMissing ||
                            (field.value === '' && !field.readonly && field.required))
                    ) {
        ...
        if (
            field !== undefined &&
            field.type === 'picklist' &&
            field.validationMessageIfFalse !== undefined &&
            field.validationMessageIfFalse !== null &&
            field.validationMessageIfFalse !== ''
        ) {
            component.set(
                'v.errorMessage',
                field.value !== field.validValue ? field.validationMessageIfFalse : ''
            );
        }
        component.set('v.previousValue', field.value);
    }
