    ...
    doUpdateRecords: function (component) {
        ...
        communityService.executeAction(
            ...
            function (returnValue) {
                ...
                if (trialChanged) {
                    component.set(
                        'v.filterData.studySitePickList',
                        initData.referringClinicsFilter.filterData.studySitePickList
                    );
                }
                component.set(
                    'v.filterValues.statusFilter',
                    initData.referringClinicsFilter.filterValues.statusFilter
                );
                component.set(
                    'v.filterValues.trialId',
                    initData.referringClinicsFilter.filterValues.trialId
                );
                component.set(
                    'v.filterValues.ssId',
                    initData.referringClinicsFilter.filterValues.ssId
                );
                component.set(
                    'v.paginationData.allRecordsCount',
                    initData.paginationData.allRecordsCount
                );
                component.set('v.paginationData.currentPage', initData.paginationData.currentPage);
                component.set(
                    'v.paginationData.currentPageCount',
                    initData.paginationData.currentPageCount
                );
                component.set('v.filteredReferringClinics', initData.filteredReferringClinics);
                component.set('v.trialId', initData.trialId);
                component.set('v.ssId', initData.ssId);
