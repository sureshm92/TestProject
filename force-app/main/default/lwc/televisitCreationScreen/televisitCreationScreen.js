...
import Dashboard_Scheduled from '@salesforce/label/c.Dashboard_Scheduled';
import RH_Canceled_Completed from '@salesforce/label/c.RH_Canceled_Completed';
import PG_AS_F_Title from '@salesforce/label/c.PG_AS_F_Title';
import Title_Place_Holder from '@salesforce/label/c.Title_Place_Holder';
import PP_Visit_Date from '@salesforce/label/c.PP_Visit_Date';
import pir_mm_dd_yyyy from '@salesforce/label/c.pir_mm_dd_yyyy';
import Start_Time from '@salesforce/label/c.Start_Time';
import Select_Time from '@salesforce/label/c.Select_Time';
import TV_TH_Duration from '@salesforce/label/c.TV_TH_Duration';
import Duration_Help_Text from '@salesforce/label/c.Duration_Help_Text';
...
export default class ModalPopupLWC extends NavigationMixin(LightningElement) {
    ...
    get options() {
        return [
            { label: this.label.Dashboard_Scheduled, value: this.label.Dashboard_Scheduled },
            { label: this.label.RH_Canceled_Completed, value: this.label.RH_Canceled_Completed },
        ];
    }
    ...
    connectedCallback() {
        this.value = this.label.Dashboard_Scheduled;
        this.placeHolder = this.label.Attendees_Place_Holder;
            ...
            .then((result) => {
                for (let i = 0; i < result.length; i++) {
                    this.attendeesList.push({
                        participantPrimaryDelegate: result[i].participantPrimaryDelegate,
