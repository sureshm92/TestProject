        ...
        component.set('v.mapMarkers', [
            {
                ...
                description:
                    siteAddress[index].studySite.Site__r.BillingStreet +
                    siteAddress[index].studySite.Site__r.BillingState +
                    ',' +
                    siteAddress[index].studySite.Site__r.BillingCountry +
                    ',' +
                    siteAddress[index].studySite.Site__r.BillingPostalCode
            }
        ]);
