...
({
    ...
    requestToRefer : function (component, event, helper) {
        ...
        component.get('v.parentComponent').find('requestToReferByHCPAction').execute(studySiteWrapper.site.Clinical_Trial_Profile__r, studySiteWrapper.site.Id, studySiteWrapper.hcpe.Id, refreshSource);
    }
})