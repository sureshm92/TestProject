({
    ...
    next: function (component, event) {
        ...
        if (
            ...
            parentIsRequired === false &&
            parentIsRequired != undefined &&
            patientisRequired === false &&
            patientisRequired != undefined
        ) {
    ...
    uploadFileInChunk: function (
        ...
        patientref.referralID__c =
            patientref.siteSelected__c + '_' + patientref.ePRPatient_ID_Number;
