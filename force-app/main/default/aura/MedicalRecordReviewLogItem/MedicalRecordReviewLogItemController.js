({
    ...
    excludeFromReferring: function (component, event, helper) {
        ...
        communityService.executeAction(
            component,
            'changeStatusToExcludeFromReferring',
            {
            ...
            function (retrunValue) {
                ...
                helper.setData(component, pEnroll);
                var Name = pEnroll.Participant_Surname__c
                    ? pEnroll.Participant_Name__c + ' ' + pEnroll.Participant_Surname__c
                    : pEnroll.Name;
                communityService.showToast(
                    'success',
                    'success',
                    Name + ' ' + $A.get('$Label.c.TST_has_been_successfully_excluded')
                );
    ...
    referToThisTrial: function (component, event, helper) {
        ...
        if (!trialId)
            communityService.showErrorToast('Error', $A.get('$Label.c.TST_Incorrect_enrollment'));
    ...
    undoExcludeFromReferring: function (component, event, helper) {
        ...
        communityService.executeAction(
            component,
            'undoChangeStatusToExcludeFromReferring',
            {
                participantEnrollmentId: pEnroll.Id
            },
            function (retrunValue) {
