...
({
    checkFields: function (component, event, helper) {
        ...
        var isValid =
            ...
            communityService.isValidEmail(delegateItem.Email__c) &&
            delegateItem.First_Name__c &&
            delegateItem.First_Name__c.trim() &&
            delegateItem.Last_Name__c &&
            delegateItem.Last_Name__c.trim();
        component.set('v.isValid', isValid);
        if (isValid && event.getType() === 'aura:valueInit')
