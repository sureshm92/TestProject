...
import PWS_Enrolled_Name from '@salesforce/label/c.PWS_Enrolled_Name';
import PWS_Enrolled_Card_Name from '@salesforce/label/c.PWS_Enrolled_Card_Name';
import Follow_up_Period from '@salesforce/label/c.Follow_up_Period';
import In_Wash_Out_Period from '@salesforce/label/c.In_Wash_Out_Period';
import Initial_Visit from '@salesforce/label/c.Initial_Visit';
import PWS_Initial_Visit_Card_Name from '@salesforce/label/c.PWS_Initial_Visit_Card_Name';
import PIR_Participation_Complete from '@salesforce/label/c.PIR_Participation_Complete';
...
import PWS_Randomization_Name from '@salesforce/label/c.PWS_Randomization_Name';
import PWS_Contact_Outcome_Screening from '@salesforce/label/c.PWS_Contact_Outcome_Screening';
import Ready_to_Screen from '@salesforce/label/c.Ready_to_Screen';
import CC_Received from '@salesforce/label/c.CC_Received';
...
import PE_ST_Eligibility from '@salesforce/label/c.PE_ST_Eligibility';
...
import Treatment_Period from '@salesforce/label/c.Treatment_Period';
import Trial_Completion from '@salesforce/label/c.Trial_Completion';
...
const label = {
    ...
    PWS_Enrolled_Name:PWS_Enrolled_Name,
    ...
    PIR_Participation_Complete:PIR_Participation_Complete,
    Pre_review_Passed:Pre_review_Passed,
    PWS_Randomization_Card_Name:PWS_Randomization_Card_Name,
    PWS_Randomization_Name:PWS_Randomization_Name,
    PWS_Contact_Outcome_Screening:PWS_Contact_Outcome_Screening,
    ...
    PE_ST_Eligibility:PE_ST_Eligibility,
