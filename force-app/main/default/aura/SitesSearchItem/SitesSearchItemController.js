...
({
    ...
    requestToRefer: function (component, event, helper) {
        ...
        component
            ...
            .find('requestToReferByHCPAction')
            .execute(
                studySiteWrapper.site.Clinical_Trial_Profile__r,
                studySiteWrapper.site.Id,
                studySiteWrapper.hcpe ? studySiteWrapper.hcpe.Id : null,
                refreshSource,
