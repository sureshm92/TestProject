({
    ...
    setMinMaxAge: function (component, event, helper){
        ...
        if(format != 'DD-MM-YYYY'){
            if(format == 'MM-YYYY'){
                partDOB = personWrapper.birthYear+'-'+personWrapper.birthMonth+'-'+component.get('v.lastDay');
            }
            else if(format == 'YYYY'){
    ...
    doCheckDOB : function(component,event,helper){
        ...
        if(component.get('v.dobConfig') == 'DD-MM-YYYY'){
            if(component.get('v.personWrapper.birthYear') === null || component.get('v.personWrapper.birthMonth') === null 
            ...
            if(component.get('v.personWrapper.birthYear') === null || component.get('v.personWrapper.birthMonth') === null 
               || component.get('v.valueAge') === null ) {
                ...
                if(component.get('v.personWrapper.birthYear') === null || component.get('v.valueAge') === null) {
                    component.set('v.disableSave', true);
                }
                else{
                    component.set('v.disableSave', false);
    ...
    setPlaceHolder : function (component,event,helper){
        var personWrapper = component.get('v.personWrapper');
        if(component.get('v.valueAge') != undefined && component.get('v.valueAge') != null && 
        ...
        if(personWrapper.birthDay != undefined && personWrapper.birthDay != null && 
        ...
        if(personWrapper.birthMonth != undefined && personWrapper.birthMonth != null && 
        ...
        if(personWrapper.birthYear != undefined && personWrapper.birthYear != null && 
    ...
    isAdultCal : function (component , event){
        if (component.get('v.contObj') && component.get('v.personWrapper')) {
            ...
            let cCode = '';
            let csCode = '';
            if (personWrapper.mailingCC != undefined && personWrapper.mailingCC != null && personWrapper.mailingCC != '') {
                cCode = personWrapper.mailingCC;
                if (personWrapper.mailingSC != undefined && personWrapper.mailingSC != null && personWrapper.mailingSC != '') {
                    if (personWrapper != '') {
