    ...
    createNewCase: function (component, text, type)  {
        ...
        communityService.executeAction(component, 'createCase', {
            ...
            if(type === 'Problem'){
                ...
                communityService.showSuccessToast(null, $A.get('$Label.c.TST_Thank_you_for_your_feedback'));
            }else if(type === 'Privacy') {
                communityService.showSuccessToast(null, $A.get('$Label.c.PG_HLP_Req_Data_Poput_Mess'));
            }
        }, function (error) {
