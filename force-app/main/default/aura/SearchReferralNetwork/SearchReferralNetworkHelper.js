                    ...
                    for (var i in returnValue) {
                        if (selectedPills) {
                            if (selectedPills[returnValue[i].Id]) {
                                ...
                                else returnValue[i].isSelected = false;
                            } else returnValue[i].isSelected = false;
                        } else returnValue[i].isSelected = false;
                    }
    ...
    handleClearPill: function (component, event) {
        ...
        if (selectedPills)
            for (var i in selectedPills)
                ...
                } else selectedList.push(selectedPills[i]);
